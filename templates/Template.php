...
class Template implements TemplateInterface
{
     ...
     */
    // retorna el header
    public static function getHeader(string $titulo = '', string $subtitulo = NULL)
    {
        return "
    ...
    {
        return ($mensaje = Session::getFlash('success')) ? "<div class='mensajeExito' onclick='this.remove()'>
        	<div>
    ...
    {
        return ($mensaje = Session::getFlash('warning')) ? "<div class='mensajeWarning' onclick='this.remove()'>
        	<div>
    ...
    {
        return ($mensaje = Session::getFlash('error')) ? "<div class='mensajeError' onclick='this.remove()'>
        	<div>
    ...
    public static function removeFilterForm(Filter $filtro, string $action = '/')
    {
